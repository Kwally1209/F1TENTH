...
class WallFollow:
    ...
    def __init__(self):
        ...
        self.drive_pub = rospy.Publisher('/vesc/low_level/ackermann_cmd_mux/output', AckermannDriveStamped,
    ...
    def lidar_callback(self, data):
        ...
        unit_angle = 270/len(distance_data) * pi/180
        ...
        if (error < 0):
            ...
            drive_msg.drive.steering_angle = 2 * PID_input

        if error > 0:
            drive_msg.drive.steering_angle = 1 * PID_input

        # if(b > 0.75):
        #     drive_msg.drive.steering_angle = 1.6
        ...
        # ------------------------ Emergency stop --------------------------- #
        stop_range = [distance_data[180], distance_data[360], distance_data[540], distance_data[720], distance_data[900]]
